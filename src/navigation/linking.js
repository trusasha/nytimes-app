...
export const linkingPrefix = 'classic://';
...
/**
 * @type {{
 *  [K in keyof screens['HomeTabs']['screens']]: screens['HomeTabs']['screens'][K]}
 *  & {[K in keyof Omit<screens, 'HomeTabs'>]: screens[K]
 * }}
 */
const screenMap = {
  ...screens['HomeTabs'].screens,
  ...screens,
};
